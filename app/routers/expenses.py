...
def create_expense_route(expense: ExpenseCreate, service: ExpenseService = Depends(get_expense_service)) -> ExpenseResponse:
    """
...
def get_all_expenses_route(service: ExpenseService = Depends(get_expense_service)) -> list[ExpenseResponse]:
    """
    Get all expenses.
...
def get_expense_by_id_route(id: int, service: ExpenseService = Depends(get_expense_service)) -> ExpenseResponse:
    """
...
def update_expense_route(id: int, expense: ExpenseUpdate, service: ExpenseService = Depends(get_expense_service)) -> ExpenseResponse:
    """
