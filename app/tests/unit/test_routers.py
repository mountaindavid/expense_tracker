...
class TestUpdateExpenseRoute:
    ...
    def test_update_expense_partial(self):
        ...
        client = TestClient(app)
        response = client.put("/expenses/1", json={"category": "Transport"})
    ...
    def test_update_expense_not_found(self):
        ...
        # Act: Make HTTP request
        client = TestClient(app)
        response = client.put("/expenses/999", json={"amount": "150.00"})
    ...
    def test_update_expense_database_error(self):
        ...
        # Act: Make HTTP request
        client = TestClient(app)
        response = client.put("/expenses/1", json={"amount": "150.00"})
